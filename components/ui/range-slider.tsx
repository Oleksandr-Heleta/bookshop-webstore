  ...
  (
    ...
    return (
      <SliderPrimitive.Root
        ...
        {...props}
      >
        <SliderPrimitive.Track className="relative h-1 w-full grow overflow-hidden rounded-full bg-amber-100">
          <SliderPrimitive.Range className="absolute h-full bg-amber-950" />
